<template>
  <div style="background-color:#F5F5F5;position:relative;top:60px;min-height:885px">
    <el-backtop />
    <br />

    <div>
      <div>
        <div style="position:fixed;width:200px;left:478px">
          ...
          <div>
            <el-card class="box-card" shadow="hover">
              <div slot="header" class="clearfix" style="height:80px">
                <div style="cursor:pointer">
                  ...
                  <div style="float:left;position:relative;left:10px">
                    ...
                    <el-button v-if="isFollow === 1" type="text" @click="follow()"><i class="el-icon-check">已关注</i></el-button>
                  </div>
                </div>
              ...
              <div v-for="blog in otherBlogs" :key="blog.id" style="top:10px;position:relative;">
                <div>
                  <a :href="'/blog/' + blog.id" style="text-decoration:none;color:black">
                    {{ blog.title }}
                  </a>
              ...
              <el-button v-if="this.otherBlogs.length === 5" type="text" @click="gotoUserPage(author.id)">查看更多</el-button>
            </el-card>
          </div>
        </div>

        <div style="background-color:white;width:740px;left:700px;position:relative;">
          <br />
          <br />
                  ...
                  <div style="height:auto;min-height:50px">
                    ...
                    <div style="left:2%;position:relative">
                      ...
                      <a style="left:5%;position:relative;">
                        ...
                        <el-button v-if="userInfo.id === comment.userId" type="text" style="color:#A9A9A9" @click="deleteComment(comment.commentId)">删除</el-button>
                      </a>

                      <div v-if="comment.flag === true">
                        <div v-if="userInfo.id > 0" style="float:left;left:5%;position:relative">
                          <el-avatar :size="30" :src="userInfo.avatar" />
                        </div>
                        <div>
                          <el-input
                        ...
                        <div v-for="rep in commentInfo" :key="rep.id">
                          <div v-if="rep.parentId === comment.commentId">
                            ...
                            <div style="position:relative">
                              <div style="float:left">
                                <div class="block">
                                  <el-avatar :size="30" :src="rep.userAvatar" style="top:3px;position:relative" />
                                </div>
                              </div>
                              <div style="left:2%;position:relative">
                                <p style="display:inline">{{ rep.username }}</p>
                                <p v-if="rep.toUsername" style="display:inline;color:#A9A9A9">回复</p>
                                <p v-if="rep.toUsername" style="display:inline">{{ rep.toUsername }}</p>
                                ...
                                <a style="left:5%;position:relative;">
                                  ...
                                  <el-button v-if="userInfo.id === rep.userId" type="text" style="color:#A9A9A9" @click="deleteComment(rep.commentId)">删除</el-button>
                                </a>
                              </div>
...
export default {
  ...
  asyncData({ params, error }) {
    return blogApi.getBlogInfoById(params.id)
    .then(response => {
      return {
